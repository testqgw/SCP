...
exports.makeAccelerateExtension = exports.FETCH_FAILURE_MESSAGE = void 0;
...
exports.FETCH_FAILURE_MESSAGE = "Unable to connect to the Accelerate API. This may be due to a network or DNS issue. Please check your connection and the Accelerate connection string. For details, visit https://www.prisma.io/docs/accelerate/troubleshoot.";
        ...
        __internalParams.customDataProxyFetch = () => {
            return async (url, options) => {
                ...
                try {
                    ...
                    throw new Error(exports.FETCH_FAILURE_MESSAGE);
                }
            };
        };
        if (__accelerateInfo) {
