...
const MARKET_ALIASES: Array<[Market, string[]]> = [
  ...
  ["PA", ["PA", "POINTS_ASSISTS", "POINTS+ASSISTS", "POINTS + ASSISTS", "PTS+AST", "TOTAL_POINTS_ASSISTS"]],
  ["PR", ["PR", "POINTS_REBOUNDS", "POINTS+REBOUNDS", "POINTS + REBOUNDS", "PTS+REB", "TOTAL_POINTS_REBOUNDS"]],
  ["RA", ["RA", "REBOUNDS_ASSISTS", "REBOUNDS+ASSISTS", "REBOUNDS + ASSISTS", "REB+AST", "TOTAL_REBOUNDS_ASSISTS"]],
