...
Generated: 2026-05-18T23:42:35.947361Z
...
| Status | Check | Detail |
|---|---|---|
| PASS | MODEL_ID_AND_VERSION | final-player-prop-model-v1 / 2026-05-18-soft-context-rerank-v5 |
...
| PASS | REPORTED_RESULTS_RECOMPUTE | Selected recompute 921-41 on 962 rows. |
...
| PASS | STRICT_NEGATIVE_LABEL_SHUFFLES | Selected accuracy 95.74% vs strongest strict shuffle P99 93.04%. |
| PASS | DATE_SHIFT_DIAGNOSTIC_EXPLAINED | Selected-rank date shift stayed high at 95.76% vs actual 95.74%, but stronger same-player/same-market controls collapsed to 56.48% with 96.47% coverage. Diagnostic retired as explained. |
...
| Test | Mean | P95 | P99 |
|---|---:|---:|---:|
| random_board_sample | 88.81% | 90.44% | 91.06% |
| random_same_market_outcomes | 88.81% | 90.54% | 91.16% |
| shuffle_labels_by_market | 88.81% | 90.54% | 91.16% |
| shuffle_labels_by_slate | 88.78% | 90.44% | 91.06% |
| shuffle_labels_by_player_market | 91.05% | 92.41% | 93.04% |
| shuffle_player_ids_preserve_date_market | 88.79% | 90.33% | 91.06% |
| shift_selected_labels_plus_1_date | 95.76% | - | - |
| shift_selected_labels_minus_1_date | 95.66% | - | - |
| shift_selected_labels_plus_3_dates | 95.74% | - | - |
| shift_selected_labels_plus_7_dates | 95.75% | - | - |
...
- Worst 30-day stretch: 2025-11-13 to 2025-12-13 at 93.68%
